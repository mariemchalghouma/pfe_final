      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-3xl font-black text-gray-900">
              1,245{" "}
              <span className="text-base text-gray-300 font-bold">km</span>
            </p>
            <div className="flex items-center gap-1 mt-2 text-green-600 text-sm font-bold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            <h2 className="text-xl font-black text-gray-900 mb-6 italic tracking-tight uppercase text-[14px]">
              Activité récente
            </h2>
            <div className="space-y-6">
              {[
                {
                  time: "14:32",
                  text: "120 TDS 4578 - Départ de Tunis",
                  color: "bg-orange-500",
                },
                {
                  time: "14:15",
                  text: "95 TDS 6543 - Arrêt non conforme à Nabeul",
                  color: "bg-red-500",
                },
                {
                  time: "13:48",
                  text: "142 TDS 8877 - En route vers Sousse",
                  color: "bg-orange-500",
                },
                {
                  time: "13:20",
                  text: "78 NGI 5544 - Arrêt à Zaghouan",
                  color: "bg-green-500",
                },
                {
                  time: "12:55",
                  text: "185 TDS 9321 - Arrêt à Manouba",
                  color: "bg-green-500",
                },
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-4">
                  <span
                    className={`w-3 h-3 rounded-full mt-1.5 shrink-0 shadow-sm ${item.color}`}
                  ></span>
                  <div>
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="w-full bg-gray-50 rounded-full h-3">
                  <div
                    className="bg-red-500 h-3 rounded-full shadow-sm"
                    style={{ width: "17%" }}
                  ></div>
                </div>
              </div>
