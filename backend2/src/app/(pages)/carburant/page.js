...
const getEtatMoteurInfo = (point) => {
  ...
  if (rawState === "arrete")
    return { key: "arrete", label: "Arrêté", color: "#ea580c", bg: "#ffedd5" };
...
export default function CarburantPage() {
  ...
  const handleRowClick = useCallback(
    async (row) => {
      ...
      if (selectedCamion && dateStart && dateEnd) {
        ...
        try {
          const res = await carburantAPI.getNiveau(selectedCamion, {
            dateStart,
            dateEnd,
          });
          if (res.success) setNiveauData(res.data);
        } catch (err) {
          console.error("Err niveau:", err);
        } finally {
  ...
  return (
    <div
      ...
      style={{ background: "#f5f6fa", fontFamily: "'Inter', sans-serif" }}
    >
      {/* ════════════ FILTERS ════════════ */}
      <div className="p-6">
        <div className="mb-8 p-1">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              style={{
                padding: "10px 22px",
                background: !selectedCamion ? "#d1d5db" : "#f97316",
                color: "white",
                fontSize: "13px",
                fontWeight: 700,
                borderRadius: "10px",
                border: "none",
                cursor: !selectedCamion ? "not-allowed" : "pointer",
                display: "inline-flex",
                alignItems: "center",
                gap: "8px",
                transition: "all 0.2s",
                fontFamily: "'Inter', sans-serif",
                boxShadow: !selectedCamion
                  ? "none"
      ...
      <div style={{ padding: "24px" }}>
        ...
        {!loading && !searched && (
          ...
          >
            ...
            >
              Choisissez un camion dans le sélecteur, puis cliquez{" "}
              <strong style={{ color: "#f97316" }}>Rechercher</strong>.
            </p>
          </div>
        )}
        ...
        {!loading && searched && rows.length === 0 && (
          ...
          >
            ...
            <p style={{ color: "#9ca3af", fontWeight: 600, fontSize: "15px" }}>
              Aucun ravitaillement trouvé pour cette période.
            </p>
          </div>
        )}
          ...
          <>
            ...
            >
              ...
              >
                ...
                >
                  Écart : {stats.ecartGlobal > 0 ? "+" : ""}
                  {stats.ecartGlobal} L (
                  {stats.totalGps > 0
                    ? (
                        (Math.abs(stats.ecartGlobal) / stats.totalGps) *
                        100
                      ).toFixed(1)
                    : 0}
                  %)
                  ...
                  >
                    <div
                      style={{
                        width:
                          stats.totalGps > 0
                            ? `${Math.min((stats.totalDeclaree / stats.totalGps) * 100, 100)}%`
                            : "0%",
                        height: "100%",
                        borderRadius: "10px",
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    fontFamily: "'Inter', sans-serif",
                    position: "relative",
                    color: detailTab === tab.id ? "#f97316" : "#6b7280",
                    transition: "all 0.2s",
                  }}
                >
                  {tab.label}
              ...
              >
                {niveauLoading ? (
                            ...
                            content={({ active, payload }) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <p
                                    style={{
                                      color: getEtatMoteurInfo(d).color,
                                      fontWeight: 700,
                                    }}
                                  >
                                  ...
                                  <p style={{ color: "#6b7280" }}>
                                    Lat: {Number(d.latitude).toFixed(5)} | Lng:{" "}
                  ...
                  <div
                    ...
                    style={{ padding: "60px 0", color: "#d1d5db" }}
                  >
                    <FiTruck
                      style={{ fontSize: "48px", marginBottom: "12px" }}
                    />
                    <p style={{ fontWeight: 600, fontSize: "14px" }}>
                      Aucune donnée GPS pour cette période
                    </p>
                  </div>
                )}
              </div>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                >
                  <div style={{ height: "400px" }}>
                    {(() => {
                      const lat =
                        selPoint?.latitude ?? selRow.latGps ?? selRow.latRavit;
                      const lng =
                        selPoint?.longitude ?? selRow.lngGps ?? selRow.lngRavit;
                      if (lat && lng) {
                        ...
                        return (
                          ...
                          >
                            ...
                            {gpsPoints.map((pt, idx) => {
                              const isSelected =
                                selPoint &&
                                String(selPoint.timestamp) ===
                                  String(pt.timestamp) &&
                                Number(selPoint.latitude) ===
                                  Number(pt.latitude) &&
                                Number(selPoint.longitude) ===
                                  Number(pt.longitude);
                                ...
                                >
                                  <Popup>
                                    ...
                                    >
                                      ...
                                      <p>
                                        Fuel: <strong>{pt.niveau} L</strong>
                                      </p>
                                      <p>
                                        Etat moteur:{" "}
                                        <strong
                                          style={{
                                            color: getEtatMoteurInfo(pt).color,
                                          }}
                                        >
                                      ...
                                      <p style={{ color: "#6b7280" }}>
                                        Lat: {Number(pt.latitude).toFixed(5)} |
                                        Lng: {Number(pt.longitude).toFixed(5)}
                                      </p>
                                    </div>
                                  </Popup>
                                </CircleMarker>
                            ...
                            {selRow.latRavit && selRow.lngRavit && (
                              <Marker
                                position={[selRow.latRavit, selRow.lngRavit]}
                                ...
                                <Popup>
                                  ...
                                  >
                                    ...
                                    <p style={{ color: "#f97316" }}>
                                      ⏰ {selPoint.heure} · {selPoint.niveau} L
                                    </p>
                                    <p>
                                      ⚙ Etat moteur:{" "}
                                      <strong
                                        style={{
                                          color:
                                            getEtatMoteurInfo(selPoint).color,
                                        }}
                                      >
                                    ...
                                    <p style={{ color: "#6b7280" }}>
                                      📍 {Number(selPoint.latitude).toFixed(5)},{" "}
                                      {Number(selPoint.longitude).toFixed(5)}
                                    </p>
                                  </div>
                                </Popup>
                              </Marker>
                              ...
                              content={({ active, payload }) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    >
                                      Etat moteur :{" "}
                                      <b>{getEtatMoteurInfo(d).label}</b>
                                    </p>
                                    <p style={{ color: "#6b7280" }}>
                                      Lat: {Number(d.latitude).toFixed(5)} |
                                      Lng: {Number(d.longitude).toFixed(5)}
                                    </p>
                                    {d.ravitaillement && (
                                      <p
                                        style={{
                  ...
                  <div style={{ background: "white", padding: "20px" }}>
                    ...
                    <p
                      style={{
                        fontSize: "17px",
                        fontWeight: 800,
                        color: selRow.ecart === 0 ? "#10b981" : "#ef4444",
                      }}
                    >
                      {selRow.ecart > 0 ? "+" : ""}
                      {selRow.ecart} L
                ...
                <div style={{ marginTop: "16px" }}>
                  {[
                    ...
                    { label: "Type", value: selRow.type },
                    {
                      label: "Prix",
                      value:
                        selRow.prix > 0 ? `${selRow.prix.toFixed(2)} DT` : "—",
                    },
                    ...(selRow.capacite
                      ? [
                          {
                            label: "Capacité réservoir",
                            value: `${selRow.capacite} L`,
                          },
                        ]
                      : []),
                  ].map((item, idx) => (
