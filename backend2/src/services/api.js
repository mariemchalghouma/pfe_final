...
export const camionsAPI = {
  ...
  getCamionTrajet: (camion, params = {}) =>
    fetchWithAuth(
      `/api/camions/${encodeURIComponent(camion)}/trajet${buildQueryString(params)}`,
    ),
  getGantt: (date) =>
...
export const ouverturesAPI = {
  getOuvertures: (params) =>
    fetchWithAuth(`/api/ouvertures${buildQueryString(params)}`),
...
export const poiAPI = {
  ...
  createPOI: (data) =>
    fetchWithAuth("/api/poi", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updatePOI: (id, data) =>
    fetchWithAuth(`/api/poi/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deletePOI: (id) =>
...
export const carburantAPI = {
  getEcarts: (params = {}) =>
    fetchWithAuth(`/api/carburant${buildQueryString(params)}`),
  getEcartsByCamion: (camion, params = {}) =>
    fetchWithAuth(
      `/api/carburant/${encodeURIComponent(camion)}${buildQueryString(params)}`,
    ),
  getNiveau: (camion, params = {}) =>
    fetchWithAuth(
      `/api/carburant/${encodeURIComponent(camion)}/niveau${buildQueryString(params)}`,
    ),
  updateAnomalie: (data) =>
    fetchWithAuth("/api/carburant/anomalies", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  submitReclamation: (data) =>
    fetchWithAuth("/api/carburant/reclamations", {
      method: "POST",
      body: JSON.stringify(data),
    }),
};
...
export const reclamationsAPI = {
  getReclamations: (params = {}) =>
    fetchWithAuth(`/api/reclamations${buildQueryString(params)}`),
};
